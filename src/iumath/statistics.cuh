...
void minMax(iu::ImageGpu<PixelType, Allocator >& d_img, PixelType& minval, PixelType& maxval)
{
 ...
 */
template<typename PixelType, class Allocator >
void summation(iu::ImageGpu<PixelType,Allocator >& d_img,PixelType initval, PixelType& sum)
{
 ...
 */
template<typename PixelType, class Allocator >
void normDiffL1(iu::ImageGpu<PixelType, Allocator >& src,
                iu::ImageGpu<PixelType, Allocator >& ref,PixelType& norm)
{
    typedef thrust::tuple<bool, PixelType> result_type;
 ...
 */
template<typename PixelType, class Allocator >
void normDiffL1(iu::ImageGpu<PixelType, Allocator >& src,PixelType& ref,PixelType& norm)
{
    typedef thrust::tuple<bool, PixelType> result_type;
    result_type init(true, 0); // initial value
    diffabs_transform_tuple<int,PixelType> unary_op(src.width(), src.stride()); // transformation operator
 ...
 */
template<typename PixelType, class Allocator >
void normDiffL2(iu::ImageGpu<PixelType,Allocator>& src,
                iu::ImageGpu<PixelType, Allocator >& ref,PixelType& norm)
{
    typedef thrust::tuple<bool, PixelType> result_type;
    result_type init(true, 0); // initial value
 ...
 */
template<typename PixelType, class Allocator >
void normDiffL2(iu::ImageGpu<PixelType, Allocator>& src,PixelType& ref,PixelType& norm)
{
    typedef thrust::tuple<bool, PixelType> result_type;
    result_type init(true, 0); // initial value
    diffsqr_transform_tuple<int,PixelType> unary_op(src.width(), src.stride()); // transformation operator
 ...
 */
template<typename PixelType, class Allocator >
void mse(iu::ImageGpu<PixelType, Allocator >& src,
         iu::ImageGpu<PixelType, Allocator >& ref,PixelType& mse)
{
