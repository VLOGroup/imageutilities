...
IUCORE_DLLAPI void addC(iu::ImageGpu_64f_C1& src, const double& val, iu::ImageGpu_64f_C1& dst);
IUCORE_DLLAPI void addC(iu::ImageGpu_64f_C2& src, const double2& val, iu::ImageGpu_64f_C2& dst);
IUCORE_DLLAPI void addC(iu::ImageGpu_64f_C3& src, const double3& val, iu::ImageGpu_64f_C3& dst);
IUCORE_DLLAPI void addC(iu::ImageGpu_64f_C4& src, const double4& val, iu::ImageGpu_64f_C4& dst);
...
IUCORE_DLLAPI void addC(iu::VolumeGpu_32f_C3& src, const float3& val, iu::VolumeGpu_32f_C3& dst);
IUCORE_DLLAPI void addC(iu::VolumeGpu_32f_C4& src, const float4& val, iu::VolumeGpu_32f_C4& dst);

IUCORE_DLLAPI void addC(iu::VolumeGpu_64f_C1& src, const double& val, iu::VolumeGpu_64f_C1& dst);
IUCORE_DLLAPI void addC(iu::VolumeGpu_64f_C2& src, const double2& val, iu::VolumeGpu_64f_C2& dst);
IUCORE_DLLAPI void addC(iu::VolumeGpu_64f_C3& src, const double3& val, iu::VolumeGpu_64f_C3& dst);
IUCORE_DLLAPI void addC(iu::VolumeGpu_64f_C4& src, const double4& val, iu::VolumeGpu_64f_C4& dst);
...
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory_64f_C1& src, const double& val, iu::LinearDeviceMemory_64f_C1& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory_64f_C2& src, const double2& val, iu::LinearDeviceMemory_64f_C2& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory_64f_C3& src, const double3& val, iu::LinearDeviceMemory_64f_C3& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory_64f_C4& src, const double4& val, iu::LinearDeviceMemory_64f_C4& dst);
...
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float, 2>& src, const float& val, iu::LinearDeviceMemory<float, 2>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float2, 2>& src, const float2& val, iu::LinearDeviceMemory<float2, 2>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float3, 2>& src, const float3& val, iu::LinearDeviceMemory<float3, 2>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float4, 2>& src, const float4& val, iu::LinearDeviceMemory<float4, 2>& dst);

IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float, 3>& src, const float& val, iu::LinearDeviceMemory<float, 3>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float2, 3>& src, const float2& val, iu::LinearDeviceMemory<float2, 3>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float3, 3>& src, const float3& val, iu::LinearDeviceMemory<float3, 3>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float4, 3>& src, const float4& val, iu::LinearDeviceMemory<float4, 3>& dst);

IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float, 4>& src, const float& val, iu::LinearDeviceMemory<float, 4>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float2, 4>& src, const float2& val, iu::LinearDeviceMemory<float2, 4>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float3, 4>& src, const float3& val, iu::LinearDeviceMemory<float3, 4>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float4, 4>& src, const float4& val, iu::LinearDeviceMemory<float4, 4>& dst);

IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float, 5>& src, const float& val, iu::LinearDeviceMemory<float, 5>& dst);
IUCORE_DLLAPI void addC(iu::LinearDeviceMemory<float2, 5>& src, const float2& val, iu::LinearDeviceMemory<float2, 5>& dst);
...
IUCORE_DLLAPI void addC(iu::ImageCpu_64f_C1& src, const double& val, iu::ImageCpu_64f_C1& dst);
IUCORE_DLLAPI void addC(iu::ImageCpu_64f_C2& src, const double2& val, iu::ImageCpu_64f_C2& dst);
IUCORE_DLLAPI void addC(iu::ImageCpu_64f_C3& src, const double3& val, iu::ImageCpu_64f_C3& dst);
IUCORE_DLLAPI void addC(iu::ImageCpu_64f_C4& src, const double4& val, iu::ImageCpu_64f_C4& dst);
...
IUCORE_DLLAPI void addC(iu::VolumeCpu_32f_C3& src, const float3& val, iu::VolumeCpu_32f_C3& dst);
IUCORE_DLLAPI void addC(iu::VolumeCpu_32f_C4& src, const float4& val, iu::VolumeCpu_32f_C4& dst);

IUCORE_DLLAPI void addC(iu::VolumeCpu_64f_C1& src, const double& val, iu::VolumeCpu_64f_C1& dst);
IUCORE_DLLAPI void addC(iu::VolumeCpu_64f_C2& src, const double2& val, iu::VolumeCpu_64f_C2& dst);
IUCORE_DLLAPI void addC(iu::VolumeCpu_64f_C3& src, const double3& val, iu::VolumeCpu_64f_C3& dst);
IUCORE_DLLAPI void addC(iu::VolumeCpu_64f_C4& src, const double4& val, iu::VolumeCpu_64f_C4& dst);
...
IUCORE_DLLAPI void addC(iu::LinearHostMemory_64f_C1& src, const double& val, iu::LinearHostMemory_64f_C1& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory_64f_C2& src, const double2& val, iu::LinearHostMemory_64f_C2& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory_64f_C3& src, const double3& val, iu::LinearHostMemory_64f_C3& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory_64f_C4& src, const double4& val, iu::LinearHostMemory_64f_C4& dst);
...
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float, 2>& src, const float& val, iu::LinearHostMemory<float, 2>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float2, 2>& src, const float2& val, iu::LinearHostMemory<float2, 2>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float3, 2>& src, const float3& val, iu::LinearHostMemory<float3, 2>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float4, 2>& src, const float4& val, iu::LinearHostMemory<float4, 2>& dst);

IUCORE_DLLAPI void addC(iu::LinearHostMemory<float, 3>& src, const float& val, iu::LinearHostMemory<float, 3>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float2, 3>& src, const float2& val, iu::LinearHostMemory<float2, 3>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float3, 3>& src, const float3& val, iu::LinearHostMemory<float3, 3>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float4, 3>& src, const float4& val, iu::LinearHostMemory<float4, 3>& dst);

IUCORE_DLLAPI void addC(iu::LinearHostMemory<float, 4>& src, const float& val, iu::LinearHostMemory<float, 4>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float2, 4>& src, const float2& val, iu::LinearHostMemory<float2, 4>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float3, 4>& src, const float3& val, iu::LinearHostMemory<float3, 4>& dst);
IUCORE_DLLAPI void addC(iu::LinearHostMemory<float4, 4>& src, const float4& val, iu::LinearHostMemory<float4, 4>& dst);

IUCORE_DLLAPI void addC(iu::LinearHostMemory<float, 5>& src, const float& val, iu::LinearHostMemory<float, 5>& dst);
...
IUCORE_DLLAPI void mulC(iu::ImageGpu_64f_C1& src, const double& val, iu::ImageGpu_64f_C1& dst);
IUCORE_DLLAPI void mulC(iu::ImageGpu_64f_C2& src, const double2& val, iu::ImageGpu_64f_C2& dst);
IUCORE_DLLAPI void mulC(iu::ImageGpu_64f_C3& src, const double3& val, iu::ImageGpu_64f_C3& dst);
IUCORE_DLLAPI void mulC(iu::ImageGpu_64f_C4& src, const double4& val, iu::ImageGpu_64f_C4& dst);
...
IUCORE_DLLAPI void mulC(iu::VolumeGpu_32f_C2& src, const float2& val, iu::VolumeGpu_32f_C2& dst);
IUCORE_DLLAPI void mulC(iu::VolumeGpu_32f_C3& src, const float3& val, iu::VolumeGpu_32f_C3& dst);
IUCORE_DLLAPI void mulC(iu::VolumeGpu_32f_C4& src, const float4& val, iu::VolumeGpu_32f_C4& dst);

IUCORE_DLLAPI void mulC(iu::VolumeGpu_64f_C1& src, const double& val, iu::VolumeGpu_64f_C1& dst);
IUCORE_DLLAPI void mulC(iu::VolumeGpu_64f_C2& src, const double2& val, iu::VolumeGpu_64f_C2& dst);
IUCORE_DLLAPI void mulC(iu::VolumeGpu_64f_C3& src, const double3& val, iu::VolumeGpu_64f_C3& dst);
IUCORE_DLLAPI void mulC(iu::VolumeGpu_64f_C4& src, const double4& val, iu::VolumeGpu_64f_C4& dst);
...
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory_64f_C1& src, const double& val, iu::LinearDeviceMemory_64f_C1& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory_64f_C2& src, const double2& val, iu::LinearDeviceMemory_64f_C2& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory_64f_C3& src, const double3& val, iu::LinearDeviceMemory_64f_C3& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory_64f_C4& src, const double4& val, iu::LinearDeviceMemory_64f_C4& dst);
...
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float, 2>& src, const float& val, iu::LinearDeviceMemory<float, 2>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float2, 2>& src, const float2& val, iu::LinearDeviceMemory<float2, 2>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float3, 2>& src, const float3& val, iu::LinearDeviceMemory<float3, 2>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float4, 2>& src, const float4& val, iu::LinearDeviceMemory<float4, 2>& dst);

IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float, 3>& src, const float& val, iu::LinearDeviceMemory<float, 3>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float2, 3>& src, const float2& val, iu::LinearDeviceMemory<float2, 3>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float3, 3>& src, const float3& val, iu::LinearDeviceMemory<float3, 3>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float4, 3>& src, const float4& val, iu::LinearDeviceMemory<float4, 3>& dst);

IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float, 4>& src, const float& val, iu::LinearDeviceMemory<float, 4>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float2, 4>& src, const float2& val, iu::LinearDeviceMemory<float2, 4>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float3, 4>& src, const float3& val, iu::LinearDeviceMemory<float3, 4>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float4, 4>& src, const float4& val, iu::LinearDeviceMemory<float4, 4>& dst);

IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float, 5>& src, const float& val, iu::LinearDeviceMemory<float, 5>& dst);
IUCORE_DLLAPI void mulC(iu::LinearDeviceMemory<float2, 5>& src, const float2& val, iu::LinearDeviceMemory<float2, 5>& dst);
...
IUCORE_DLLAPI void mulC(iu::ImageCpu_64f_C1& src, const double& val, iu::ImageCpu_64f_C1& dst);
IUCORE_DLLAPI void mulC(iu::ImageCpu_64f_C2& src, const double2& val, iu::ImageCpu_64f_C2& dst);
IUCORE_DLLAPI void mulC(iu::ImageCpu_64f_C3& src, const double3& val, iu::ImageCpu_64f_C3& dst);
IUCORE_DLLAPI void mulC(iu::ImageCpu_64f_C4& src, const double4& val, iu::ImageCpu_64f_C4& dst);
...
IUCORE_DLLAPI void mulC(iu::VolumeCpu_32f_C2& src, const float2& val, iu::VolumeCpu_32f_C2& dst);
IUCORE_DLLAPI void mulC(iu::VolumeCpu_32f_C3& src, const float3& val, iu::VolumeCpu_32f_C3& dst);
IUCORE_DLLAPI void mulC(iu::VolumeCpu_32f_C4& src, const float4& val, iu::VolumeCpu_32f_C4& dst);

IUCORE_DLLAPI void mulC(iu::VolumeCpu_64f_C1& src, const double& val, iu::VolumeCpu_64f_C1& dst);
IUCORE_DLLAPI void mulC(iu::VolumeCpu_64f_C2& src, const double2& val, iu::VolumeCpu_64f_C2& dst);
IUCORE_DLLAPI void mulC(iu::VolumeCpu_64f_C3& src, const double3& val, iu::VolumeCpu_64f_C3& dst);
IUCORE_DLLAPI void mulC(iu::VolumeCpu_64f_C4& src, const double4& val, iu::VolumeCpu_64f_C4& dst);
...
IUCORE_DLLAPI void mulC(iu::LinearHostMemory_64f_C1& src, const double& val, iu::LinearHostMemory_64f_C1& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory_64f_C2& src, const double2& val, iu::LinearHostMemory_64f_C2& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory_64f_C3& src, const double3& val, iu::LinearHostMemory_64f_C3& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory_64f_C4& src, const double4& val, iu::LinearHostMemory_64f_C4& dst);
...
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float, 2>& src, const float& val, iu::LinearHostMemory<float, 2>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float2, 2>& src, const float2& val, iu::LinearHostMemory<float2, 2>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float3, 2>& src, const float3& val, iu::LinearHostMemory<float3, 2>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float4, 2>& src, const float4& val, iu::LinearHostMemory<float4, 2>& dst);

IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float, 3>& src, const float& val, iu::LinearHostMemory<float, 3>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float2, 3>& src, const float2& val, iu::LinearHostMemory<float2, 3>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float3, 3>& src, const float3& val, iu::LinearHostMemory<float3, 3>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float4, 3>& src, const float4& val, iu::LinearHostMemory<float4, 3>& dst);

IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float, 4>& src, const float& val, iu::LinearHostMemory<float, 4>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float2, 4>& src, const float2& val, iu::LinearHostMemory<float2, 4>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float3, 4>& src, const float3& val, iu::LinearHostMemory<float3, 4>& dst);
IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float4, 4>& src, const float4& val, iu::LinearHostMemory<float4, 4>& dst);

IUCORE_DLLAPI void mulC(iu::LinearHostMemory<float, 5>& src, const float& val, iu::LinearHostMemory<float, 5>& dst);
...
IUCORE_DLLAPI void addWeighted(iu::ImageGpu_64f_C1& src1, const double& weight1,
                 iu::ImageGpu_64f_C1& src2, const double& weight2,iu::ImageGpu_64f_C1& dst);
IUCORE_DLLAPI void addWeighted(iu::ImageGpu_64f_C2& src1, const double2& weight1,
                 iu::ImageGpu_64f_C2& src2, const double2& weight2,iu::ImageGpu_64f_C2& dst);
IUCORE_DLLAPI void addWeighted(iu::ImageGpu_64f_C3& src1, const double3& weight1,
                 iu::ImageGpu_64f_C3& src2, const double3& weight2,iu::ImageGpu_64f_C3& dst);
IUCORE_DLLAPI void addWeighted(iu::ImageGpu_64f_C4& src1, const double4& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::VolumeGpu_32f_C2& src1, const float2& weight1,
                 iu::VolumeGpu_32f_C2& src2, const float2& weight2,iu::VolumeGpu_32f_C2& dst);
IUCORE_DLLAPI void addWeighted(iu::VolumeGpu_64f_C1& src1, const double& weight1,
                 iu::VolumeGpu_64f_C1& src2, const double& weight2,iu::VolumeGpu_64f_C1& dst);
IUCORE_DLLAPI void addWeighted(iu::VolumeGpu_64f_C2& src1, const double2& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory_64f_C1& src1, const double& weight1,
                 iu::LinearDeviceMemory_64f_C1& src2, const double& weight2,iu::LinearDeviceMemory_64f_C1& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory_64f_C2& src1, const double2& weight1,
                 iu::LinearDeviceMemory_64f_C2& src2, const double2& weight2,iu::LinearDeviceMemory_64f_C2& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory_64f_C3& src1, const double3& weight1,
                 iu::LinearDeviceMemory_64f_C3& src2, const double3& weight2,iu::LinearDeviceMemory_64f_C3& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory_64f_C4& src1, const double4& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float, 2>& src1, const float& weight1,
                 iu::LinearDeviceMemory<float, 2>& src2, const float& weight2,iu::LinearDeviceMemory<float, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float2, 2>& src1, const float2& weight1,
                 iu::LinearDeviceMemory<float2, 2>& src2, const float2& weight2,iu::LinearDeviceMemory<float2, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float3, 2>& src1, const float3& weight1,
                 iu::LinearDeviceMemory<float3, 2>& src2, const float3& weight2,iu::LinearDeviceMemory<float3, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float4, 2>& src1, const float4& weight1,
                 iu::LinearDeviceMemory<float4, 2>& src2, const float4& weight2,iu::LinearDeviceMemory<float4, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float, 3>& src1, const float& weight1,
                 iu::LinearDeviceMemory<float, 3>& src2, const float& weight2,iu::LinearDeviceMemory<float, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float2, 3>& src1, const float2& weight1,
                 iu::LinearDeviceMemory<float2, 3>& src2, const float2& weight2,iu::LinearDeviceMemory<float2, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float3, 3>& src1, const float3& weight1,
                 iu::LinearDeviceMemory<float3, 3>& src2, const float3& weight2,iu::LinearDeviceMemory<float3, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float4, 3>& src1, const float4& weight1,
                 iu::LinearDeviceMemory<float4, 3>& src2, const float4& weight2,iu::LinearDeviceMemory<float4, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float, 4>& src1, const float& weight1,
                 iu::LinearDeviceMemory<float, 4>& src2, const float& weight2,iu::LinearDeviceMemory<float, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float2, 4>& src1, const float2& weight1,
                 iu::LinearDeviceMemory<float2, 4>& src2, const float2& weight2,iu::LinearDeviceMemory<float2, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float3, 4>& src1, const float3& weight1,
                 iu::LinearDeviceMemory<float3, 4>& src2, const float3& weight2,iu::LinearDeviceMemory<float3, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float4, 4>& src1, const float4& weight1,
                 iu::LinearDeviceMemory<float4, 4>& src2, const float4& weight2,iu::LinearDeviceMemory<float4, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float, 5>& src1, const float& weight1,
                 iu::LinearDeviceMemory<float, 5>& src2, const float& weight2,iu::LinearDeviceMemory<float, 5>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float2, 5>& src1, const float2& weight1,
                 iu::LinearDeviceMemory<float2, 5>& src2, const float2& weight2,iu::LinearDeviceMemory<float2, 5>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearDeviceMemory<float3, 5>& src1, const float3& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::ImageCpu_64f_C1& src1, const double& weight1,
                 iu::ImageCpu_64f_C1& src2, const double& weight2,iu::ImageCpu_64f_C1& dst);
IUCORE_DLLAPI void addWeighted(iu::ImageCpu_64f_C2& src1, const double2& weight1,
                 iu::ImageCpu_64f_C2& src2, const double2& weight2,iu::ImageCpu_64f_C2& dst);
IUCORE_DLLAPI void addWeighted(iu::ImageCpu_64f_C3& src1, const double3& weight1,
                 iu::ImageCpu_64f_C3& src2, const double3& weight2,iu::ImageCpu_64f_C3& dst);
IUCORE_DLLAPI void addWeighted(iu::ImageCpu_64f_C4& src1, const double4& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::VolumeCpu_32f_C2& src1, const float2& weight1,
                 iu::VolumeCpu_32f_C2& src2, const float2& weight2,iu::VolumeCpu_32f_C2& dst);
IUCORE_DLLAPI void addWeighted(iu::VolumeCpu_64f_C1& src1, const double& weight1,
                 iu::VolumeCpu_64f_C1& src2, const double& weight2,iu::VolumeCpu_64f_C1& dst);
IUCORE_DLLAPI void addWeighted(iu::VolumeCpu_64f_C2& src1, const double2& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory_64f_C1& src1, const double& weight1,
                 iu::LinearHostMemory_64f_C1& src2, const double& weight2,iu::LinearHostMemory_64f_C1& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory_64f_C2& src1, const double2& weight1,
                 iu::LinearHostMemory_64f_C2& src2, const double2& weight2,iu::LinearHostMemory_64f_C2& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory_64f_C3& src1, const double3& weight1,
                 iu::LinearHostMemory_64f_C3& src2, const double3& weight2,iu::LinearHostMemory_64f_C3& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory_64f_C4& src1, const double4& weight1,
...
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float, 2>& src1, const float& weight1,
                 iu::LinearHostMemory<float, 2>& src2, const float& weight2,iu::LinearHostMemory<float, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float2, 2>& src1, const float2& weight1,
                 iu::LinearHostMemory<float2, 2>& src2, const float2& weight2,iu::LinearHostMemory<float2, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float3, 2>& src1, const float3& weight1,
                 iu::LinearHostMemory<float3, 2>& src2, const float3& weight2,iu::LinearHostMemory<float3, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float4, 2>& src1, const float4& weight1,
                 iu::LinearHostMemory<float4, 2>& src2, const float4& weight2,iu::LinearHostMemory<float4, 2>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float, 3>& src1, const float& weight1,
                 iu::LinearHostMemory<float, 3>& src2, const float& weight2,iu::LinearHostMemory<float, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float2, 3>& src1, const float2& weight1,
                 iu::LinearHostMemory<float2, 3>& src2, const float2& weight2,iu::LinearHostMemory<float2, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float3, 3>& src1, const float3& weight1,
                 iu::LinearHostMemory<float3, 3>& src2, const float3& weight2,iu::LinearHostMemory<float3, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float4, 3>& src1, const float4& weight1,
                 iu::LinearHostMemory<float4, 3>& src2, const float4& weight2,iu::LinearHostMemory<float4, 3>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float, 4>& src1, const float& weight1,
                 iu::LinearHostMemory<float, 4>& src2, const float& weight2,iu::LinearHostMemory<float, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float2, 4>& src1, const float2& weight1,
                 iu::LinearHostMemory<float2, 4>& src2, const float2& weight2,iu::LinearHostMemory<float2, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float3, 4>& src1, const float3& weight1,
                 iu::LinearHostMemory<float3, 4>& src2, const float3& weight2,iu::LinearHostMemory<float3, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float4, 4>& src1, const float4& weight1,
                 iu::LinearHostMemory<float4, 4>& src2, const float4& weight2,iu::LinearHostMemory<float4, 4>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float, 5>& src1, const float& weight1,
                 iu::LinearHostMemory<float, 5>& src2, const float& weight2,iu::LinearHostMemory<float, 5>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float2, 5>& src1, const float2& weight1,
                 iu::LinearHostMemory<float2, 5>& src2, const float2& weight2,iu::LinearHostMemory<float2, 5>& dst);
IUCORE_DLLAPI void addWeighted(iu::LinearHostMemory<float3, 5>& src1, const float3& weight1,
...
IUCORE_DLLAPI void mul(iu::ImageGpu_64f_C1& src1, iu::ImageGpu_64f_C1& src2, iu::ImageGpu_64f_C1& dst);
IUCORE_DLLAPI void mul(iu::ImageGpu_64f_C2& src1, iu::ImageGpu_64f_C2& src2, iu::ImageGpu_64f_C2& dst);
IUCORE_DLLAPI void mul(iu::ImageGpu_64f_C3& src1, iu::ImageGpu_64f_C3& src2, iu::ImageGpu_64f_C3& dst);
IUCORE_DLLAPI void mul(iu::ImageGpu_64f_C4& src1, iu::ImageGpu_64f_C4& src2, iu::ImageGpu_64f_C4& dst);
...
IUCORE_DLLAPI void mul(iu::VolumeGpu_64f_C1& src1, iu::VolumeGpu_64f_C1& src2, iu::VolumeGpu_64f_C1& dst);
...
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float, 2>& src1, iu::LinearDeviceMemory<float, 2>& src2, iu::LinearDeviceMemory<float, 2>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float2, 2>& src1, iu::LinearDeviceMemory<float2, 2>& src2, iu::LinearDeviceMemory<float2, 2>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float3, 2>& src1, iu::LinearDeviceMemory<float3, 2>& src2, iu::LinearDeviceMemory<float3, 2>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float4, 2>& src1, iu::LinearDeviceMemory<float4, 2>& src2, iu::LinearDeviceMemory<float4, 2>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float, 3>& src1, iu::LinearDeviceMemory<float, 3>& src2, iu::LinearDeviceMemory<float, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float2, 3>& src1, iu::LinearDeviceMemory<float2, 3>& src2, iu::LinearDeviceMemory<float2, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float3, 3>& src1, iu::LinearDeviceMemory<float3, 3>& src2, iu::LinearDeviceMemory<float3, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float4, 3>& src1, iu::LinearDeviceMemory<float4, 3>& src2, iu::LinearDeviceMemory<float4, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float, 4>& src1, iu::LinearDeviceMemory<float, 4>& src2, iu::LinearDeviceMemory<float, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float2, 4>& src1, iu::LinearDeviceMemory<float2, 4>& src2, iu::LinearDeviceMemory<float2, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float3, 4>& src1, iu::LinearDeviceMemory<float3, 4>& src2, iu::LinearDeviceMemory<float3, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float4, 4>& src1, iu::LinearDeviceMemory<float4, 4>& src2, iu::LinearDeviceMemory<float4, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float, 5>& src1, iu::LinearDeviceMemory<float, 5>& src2, iu::LinearDeviceMemory<float, 5>& dst);
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory<float2, 5>& src1, iu::LinearDeviceMemory<float2, 5>& src2, iu::LinearDeviceMemory<float2, 5>& dst);
...
IUCORE_DLLAPI void mul(iu::LinearDeviceMemory_64f_C4& src1, iu::LinearDeviceMemory_64f_C4& src2, iu::LinearDeviceMemory_64f_C4& dst);
...
IUCORE_DLLAPI void mul(iu::ImageCpu_64f_C1& src1, iu::ImageCpu_64f_C1& src2, iu::ImageCpu_64f_C1& dst);
IUCORE_DLLAPI void mul(iu::ImageCpu_64f_C2& src1, iu::ImageCpu_64f_C2& src2, iu::ImageCpu_64f_C2& dst);
IUCORE_DLLAPI void mul(iu::ImageCpu_64f_C3& src1, iu::ImageCpu_64f_C3& src2, iu::ImageCpu_64f_C3& dst);
IUCORE_DLLAPI void mul(iu::ImageCpu_64f_C4& src1, iu::ImageCpu_64f_C4& src2, iu::ImageCpu_64f_C4& dst);
...
IUCORE_DLLAPI void mul(iu::VolumeCpu_64f_C1& src1, iu::VolumeCpu_64f_C1& src2, iu::VolumeCpu_64f_C1& dst);
...
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float4, 2>& src1, iu::LinearHostMemory<float4, 2>& src2, iu::LinearHostMemory<float4, 2>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float, 3>& src1, iu::LinearHostMemory<float, 3>& src2, iu::LinearHostMemory<float, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float2, 3>& src1, iu::LinearHostMemory<float2, 3>& src2, iu::LinearHostMemory<float2, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float3, 3>& src1, iu::LinearHostMemory<float3, 3>& src2, iu::LinearHostMemory<float3, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float4, 3>& src1, iu::LinearHostMemory<float4, 3>& src2, iu::LinearHostMemory<float4, 3>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float, 4>& src1, iu::LinearHostMemory<float, 4>& src2, iu::LinearHostMemory<float, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float2, 4>& src1, iu::LinearHostMemory<float2, 4>& src2, iu::LinearHostMemory<float2, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float3, 4>& src1, iu::LinearHostMemory<float3, 4>& src2, iu::LinearHostMemory<float3, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float4, 4>& src1, iu::LinearHostMemory<float4, 4>& src2, iu::LinearHostMemory<float4, 4>& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory<float, 5>& src1, iu::LinearHostMemory<float, 5>& src2, iu::LinearHostMemory<float, 5>& dst);
...
IUCORE_DLLAPI void mul(iu::LinearHostMemory_64f_C3& src1, iu::LinearHostMemory_64f_C3& src2, iu::LinearHostMemory_64f_C3& dst);
IUCORE_DLLAPI void mul(iu::LinearHostMemory_64f_C4& src1, iu::LinearHostMemory_64f_C4& src2, iu::LinearHostMemory_64f_C4& dst);
...
IUCORE_DLLAPI void fill(iu::ImageGpu_64f_C1& dst, double value);
IUCORE_DLLAPI void fill(iu::ImageGpu_64f_C2& dst, double2 value);
IUCORE_DLLAPI void fill(iu::ImageGpu_64f_C4& dst, double4 value);
...
IUCORE_DLLAPI void fill(iu::ImageCpu_64f_C1& dst, double value);
IUCORE_DLLAPI void fill(iu::ImageCpu_64f_C2& dst, double2 value);
IUCORE_DLLAPI void fill(iu::ImageCpu_64f_C4& dst, double4 value);
...
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory_64f_C1& dst, double value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory_64f_C2& dst, double2 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory_64f_C3& dst, double3 value);
...
IUCORE_DLLAPI void fill(iu::LinearHostMemory_64f_C1& dst, double value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory_64f_C2& dst, double2 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory_64f_C3& dst, double3 value);
...
IUCORE_DLLAPI void fill(iu::VolumeGpu_64f_C1& dst, double value);
IUCORE_DLLAPI void fill(iu::VolumeGpu_64f_C2& dst, double2 value);
IUCORE_DLLAPI void fill(iu::VolumeGpu_64f_C3& dst, double3 value);
...
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float, 5>& dst, float value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float2, 2>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float2, 3>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float2, 4>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float2, 5>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float3, 2>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float3, 3>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float3, 4>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float3, 5>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float4, 2>& dst, float4 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float4, 3>& dst, float4 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float4, 4>& dst, float4 value);
IUCORE_DLLAPI void fill(iu::LinearDeviceMemory<float4, 5>& dst, float4 value);
...
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float, 5>& dst, float value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float2, 2>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float2, 3>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float2, 4>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float2, 5>& dst, float2 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float3, 2>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float3, 3>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float3, 4>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float3, 5>& dst, float3 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float4, 2>& dst, float4 value);
IUCORE_DLLAPI void fill(iu::LinearHostMemory<float4, 3>& dst, float4 value);
...
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float2, 2>& src, iu::LinearDeviceMemory<float, 2>& dst1, iu::LinearDeviceMemory<float, 2>& dst2);
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float2, 2>& src, iu::LinearHostMemory<float, 2>& dst1, iu::LinearHostMemory<float, 2>& dst2);
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float2, 3>& src, iu::LinearDeviceMemory<float, 3>& dst1, iu::LinearDeviceMemory<float, 3>& dst2);
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float2, 3>& src, iu::LinearHostMemory<float, 3>& dst1, iu::LinearHostMemory<float, 3>& dst2);
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float2, 4>& src, iu::LinearDeviceMemory<float, 4>& dst1, iu::LinearDeviceMemory<float, 4>& dst2);
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float2, 4>& src, iu::LinearHostMemory<float, 4>& dst1, iu::LinearHostMemory<float, 4>& dst2);
...
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float3, 2>& src, iu::LinearHostMemory<float, 2>& dst1, iu::LinearHostMemory<float, 2>& dst2, iu::LinearHostMemory<float, 2>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float3, 2>& src, iu::LinearDeviceMemory<float, 2>& dst1, iu::LinearDeviceMemory<float, 2>& dst2, iu::LinearDeviceMemory<float, 2>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float3, 3>& src, iu::LinearHostMemory<float, 3>& dst1, iu::LinearHostMemory<float, 3>& dst2, iu::LinearHostMemory<float, 3>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float3, 3>& src, iu::LinearDeviceMemory<float, 3>& dst1, iu::LinearDeviceMemory<float, 3>& dst2, iu::LinearDeviceMemory<float, 3>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float3, 4>& src, iu::LinearHostMemory<float, 4>& dst1, iu::LinearHostMemory<float, 4>& dst2, iu::LinearHostMemory<float, 4>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float3, 4>& src, iu::LinearDeviceMemory<float, 4>& dst1, iu::LinearDeviceMemory<float, 4>& dst2, iu::LinearDeviceMemory<float, 4>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearHostMemory<float3, 5>& src, iu::LinearHostMemory<float, 5>& dst1, iu::LinearHostMemory<float, 5>& dst2, iu::LinearHostMemory<float, 5>& dst3);
IUCORE_DLLAPI void splitPlanes(iu::LinearDeviceMemory<float3, 5>& src, iu::LinearDeviceMemory<float, 5>& dst1, iu::LinearDeviceMemory<float, 5>& dst2, iu::LinearDeviceMemory<float, 5>& dst3);

IUCORE_DLLAPI void splitPlanes(iu::VolumeCpu_64f_C3& src, iu::VolumeCpu_64f_C1& dst1, iu::VolumeCpu_64f_C1& dst2, iu::VolumeCpu_64f_C1& dst3);
IUCORE_DLLAPI void splitPlanes(iu::VolumeGpu_64f_C3& src, iu::VolumeGpu_64f_C1& dst1, iu::VolumeGpu_64f_C1& dst2, iu::VolumeGpu_64f_C1& dst3);
IUCORE_DLLAPI void splitPlanes(iu::ImageCpu_64f_C3& src, iu::ImageCpu_64f_C1& dst1, iu::ImageCpu_64f_C1& dst2, iu::ImageCpu_64f_C1& dst3);
IUCORE_DLLAPI void splitPlanes(iu::ImageGpu_64f_C3& src, iu::ImageGpu_64f_C1& dst1, iu::ImageGpu_64f_C1& dst2, iu::ImageGpu_64f_C1& dst3);
...
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 2>& src1, iu::LinearHostMemory<float, 2>& src2, iu::LinearHostMemory<float2, 2>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 2>& src1, iu::LinearDeviceMemory<float, 2>& src2, iu::LinearDeviceMemory<float2, 2>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 3>& src1, iu::LinearHostMemory<float, 3>& src2, iu::LinearHostMemory<float2, 3>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 3>& src1, iu::LinearDeviceMemory<float, 3>& src2, iu::LinearDeviceMemory<float2, 3>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 4>& src1, iu::LinearHostMemory<float, 4>& src2, iu::LinearHostMemory<float2, 4>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 4>& src1, iu::LinearDeviceMemory<float, 4>& src2, iu::LinearDeviceMemory<float2, 4>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 5>& src1, iu::LinearHostMemory<float, 5>& src2, iu::LinearHostMemory<float2, 5>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 5>& src1, iu::LinearDeviceMemory<float, 5>& src2, iu::LinearDeviceMemory<float2, 5>& dst);

IUCORE_DLLAPI void combinePlanes(iu::VolumeCpu_64f_C1& src1, iu::VolumeCpu_64f_C1& src2, iu::VolumeCpu_64f_C2& dst);
IUCORE_DLLAPI void combinePlanes(iu::VolumeGpu_64f_C1& src1, iu::VolumeGpu_64f_C1& src2, iu::VolumeGpu_64f_C2& dst);
IUCORE_DLLAPI void combinePlanes(iu::ImageCpu_64f_C1& src1, iu::ImageCpu_64f_C1& src2, iu::ImageCpu_64f_C2& dst);
...
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 2>& src1, iu::LinearHostMemory<float, 2>& src2, iu::LinearHostMemory<float, 2>& src3, iu::LinearHostMemory<float3, 2>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 2>& src1, iu::LinearDeviceMemory<float, 2>& src2, iu::LinearDeviceMemory<float, 2>& src3, iu::LinearDeviceMemory<float3, 2>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 3>& src1, iu::LinearHostMemory<float, 3>& src2, iu::LinearHostMemory<float, 3>& src3, iu::LinearHostMemory<float3, 3>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 3>& src1, iu::LinearDeviceMemory<float, 3>& src2, iu::LinearDeviceMemory<float, 3>& src3, iu::LinearDeviceMemory<float3, 3>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 4>& src1, iu::LinearHostMemory<float, 4>& src2, iu::LinearHostMemory<float, 4>& src3, iu::LinearHostMemory<float3, 4>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 4>& src1, iu::LinearDeviceMemory<float, 4>& src2, iu::LinearDeviceMemory<float, 4>& src3, iu::LinearDeviceMemory<float3, 4>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearHostMemory<float, 5>& src1, iu::LinearHostMemory<float, 5>& src2, iu::LinearHostMemory<float, 5>& src3, iu::LinearHostMemory<float3, 5>& dst);
IUCORE_DLLAPI void combinePlanes(iu::LinearDeviceMemory<float, 5>& src1, iu::LinearDeviceMemory<float, 5>& src2, iu::LinearDeviceMemory<float, 5>& src3, iu::LinearDeviceMemory<float3, 5>& dst);

IUCORE_DLLAPI void combinePlanes(iu::VolumeCpu_64f_C1& src1, iu::VolumeCpu_64f_C1& src2, iu::VolumeCpu_64f_C1& src3, iu::VolumeCpu_64f_C3& dst);
IUCORE_DLLAPI void combinePlanes(iu::VolumeGpu_64f_C1& src1, iu::VolumeGpu_64f_C1& src2, iu::VolumeGpu_64f_C1& src3, iu::VolumeGpu_64f_C3& dst);
IUCORE_DLLAPI void combinePlanes(iu::ImageCpu_64f_C1& src1, iu::ImageCpu_64f_C1& src2, iu::ImageCpu_64f_C1& src3, iu::ImageCpu_64f_C3& dst);
...
IUCORE_DLLAPI void minMax(iu::ImageGpu_64f_C1& src, double& minVal, double& maxVal);
IUCORE_DLLAPI void minMax(iu::VolumeGpu_64f_C1& src, double& minVal, double& maxVal);

IUCORE_DLLAPI void minMax(iu::ImageCpu_64f_C1& src, double& minVal, double& maxVal);
IUCORE_DLLAPI void minMax(iu::VolumeCpu_64f_C1& src, double& minVal, double& maxVal);
...
IUCORE_DLLAPI void minMax(iu::LinearHostMemory<float, 2>& src, float& minVal, float& maxVal, unsigned int& minIdx, unsigned int& maxIdx);
IUCORE_DLLAPI void minMax(iu::LinearDeviceMemory<float, 3>& src, float& minVal, float& maxVal, unsigned int& minIdx, unsigned int& maxIdx);
IUCORE_DLLAPI void minMax(iu::LinearHostMemory<float, 3>& src, float& minVal, float& maxVal, unsigned int& minIdx, unsigned int& maxIdx);
IUCORE_DLLAPI void minMax(iu::LinearDeviceMemory<float, 4>& src, float& minVal, float& maxVal, unsigned int& minIdx, unsigned int& maxIdx);
IUCORE_DLLAPI void minMax(iu::LinearHostMemory<float, 4>& src, float& minVal, float& maxVal, unsigned int& minIdx, unsigned int& maxIdx);
...
IUCORE_DLLAPI void summation(iu::LinearDeviceMemory<float, 2>& src, float& sum);
IUCORE_DLLAPI void summation(iu::LinearDeviceMemory<float, 3>& src, float& sum);
IUCORE_DLLAPI void summation(iu::LinearDeviceMemory<float, 4>& src, float& sum);
IUCORE_DLLAPI void summation(iu::LinearDeviceMemory<float, 5>& src, float& sum);
...
IUCORE_DLLAPI void summation(iu::LinearHostMemory<float, 2>& src, float& sum);
IUCORE_DLLAPI void summation(iu::LinearHostMemory<float, 3>& src, float& sum);
...
IUCORE_DLLAPI void normDiffL1(iu::ImageGpu_64f_C1& src, iu::ImageGpu_64f_C1& ref, double& norm);
IUCORE_DLLAPI void normDiffL1(iu::VolumeGpu_64f_C1& src, iu::VolumeGpu_64f_C1& ref, double& norm);

IUCORE_DLLAPI void normDiffL1(iu::ImageCpu_64f_C1& src, iu::ImageCpu_64f_C1& ref, double& norm);
IUCORE_DLLAPI void normDiffL1(iu::VolumeCpu_64f_C1& src, iu::VolumeCpu_64f_C1& ref, double& norm);
...
IUCORE_DLLAPI void normDiffL1(iu::ImageGpu_64f_C1& src, double& ref, double& norm);
IUCORE_DLLAPI void normDiffL1(iu::VolumeGpu_64f_C1& src, double& ref, double& norm);

IUCORE_DLLAPI void normDiffL1(iu::ImageCpu_64f_C1& src, double& ref, double& norm);
IUCORE_DLLAPI void normDiffL1(iu::VolumeCpu_64f_C1& src, double& ref, double& norm);
...
IUCORE_DLLAPI void normDiffL2(iu::ImageGpu_64f_C1& src, iu::ImageGpu_64f_C1& ref, double& norm);
IUCORE_DLLAPI void normDiffL2(iu::VolumeGpu_64f_C1& src, iu::VolumeGpu_64f_C1& ref, double& norm);

IUCORE_DLLAPI void normDiffL2(iu::ImageCpu_64f_C1& src, iu::ImageCpu_64f_C1& ref, double& norm);
IUCORE_DLLAPI void normDiffL2(iu::VolumeCpu_64f_C1& src, iu::VolumeCpu_64f_C1& ref, double& norm);
...
IUCORE_DLLAPI void normDiffL2(iu::ImageGpu_64f_C1& src, double& ref, double& norm);
IUCORE_DLLAPI void normDiffL2(iu::VolumeGpu_64f_C1& src, double& ref, double& norm);

IUCORE_DLLAPI void normDiffL2(iu::ImageCpu_64f_C1& src, double& ref, double& norm);
IUCORE_DLLAPI void normDiffL2(iu::VolumeCpu_64f_C1& src, double& ref, double& norm);
...
IUCORE_DLLAPI void mse(iu::ImageGpu_64f_C1& src, iu::ImageGpu_64f_C1& ref, double& mse);
IUCORE_DLLAPI void mse(iu::VolumeGpu_64f_C1& src, iu::VolumeGpu_64f_C1& ref, double& mse);

IUCORE_DLLAPI void mse(iu::ImageCpu_64f_C1& src, iu::ImageCpu_64f_C1& ref, double& mse);
IUCORE_DLLAPI void mse(iu::VolumeCpu_64f_C1& src, iu::VolumeCpu_64f_C1& ref, double& mse);
...
IUCORE_DLLAPI void abs(iu::LinearHostMemory<float2, 4>& complex, iu::LinearHostMemory<float, 4>& real);
IUCORE_DLLAPI void abs(iu::LinearDeviceMemory<float2, 4>& complex, iu::LinearDeviceMemory<float, 4>& real);
IUCORE_DLLAPI void abs(iu::LinearHostMemory<float2, 5>& complex, iu::LinearHostMemory<float, 5>& real);
IUCORE_DLLAPI void abs(iu::LinearDeviceMemory<float2, 5>& complex, iu::LinearDeviceMemory<float, 5>& real);

IUCORE_DLLAPI void abs(iu::VolumeCpu_64f_C2& complex, iu::VolumeCpu_64f_C1& real);
IUCORE_DLLAPI void abs(iu::VolumeGpu_64f_C2& complex, iu::VolumeGpu_64f_C1& real);
IUCORE_DLLAPI void abs(iu::ImageCpu_64f_C2& complex, iu::ImageCpu_64f_C1& real);
IUCORE_DLLAPI void abs(iu::ImageGpu_64f_C2& complex, iu::ImageGpu_64f_C1& real);
...
IUCORE_DLLAPI void real(iu::LinearDeviceMemory<float2, 3>& complex, iu::LinearDeviceMemory<float, 3>& real);
IUCORE_DLLAPI void real(iu::LinearHostMemory<float2, 4>& complex, iu::LinearHostMemory<float, 4>& real);
IUCORE_DLLAPI void real(iu::LinearDeviceMemory<float2, 4>& complex, iu::LinearDeviceMemory<float, 4>& real);
IUCORE_DLLAPI void real(iu::LinearHostMemory<float2, 5>& complex, iu::LinearHostMemory<float, 5>& real);
IUCORE_DLLAPI void real(iu::LinearDeviceMemory<float2, 5>& complex, iu::LinearDeviceMemory<float, 5>& real);

IUCORE_DLLAPI void real(iu::VolumeCpu_64f_C2& complex, iu::VolumeCpu_64f_C1& real);
IUCORE_DLLAPI void real(iu::VolumeGpu_64f_C2& complex, iu::VolumeGpu_64f_C1& real);
IUCORE_DLLAPI void real(iu::ImageCpu_64f_C2& complex, iu::ImageCpu_64f_C1& real);
IUCORE_DLLAPI void real(iu::ImageGpu_64f_C2& complex, iu::ImageGpu_64f_C1& real);
...
IUCORE_DLLAPI void imag(iu::LinearDeviceMemory<float2, 3>& complex, iu::LinearDeviceMemory<float, 3>& real);
IUCORE_DLLAPI void imag(iu::LinearHostMemory<float2, 4>& complex, iu::LinearHostMemory<float, 4>& real);
IUCORE_DLLAPI void imag(iu::LinearDeviceMemory<float2, 4>& complex, iu::LinearDeviceMemory<float, 4>& real);
IUCORE_DLLAPI void imag(iu::LinearHostMemory<float2, 5>& complex, iu::LinearHostMemory<float, 5>& real);
IUCORE_DLLAPI void imag(iu::LinearDeviceMemory<float2, 5>& complex, iu::LinearDeviceMemory<float, 5>& real);

IUCORE_DLLAPI void imag(iu::VolumeCpu_64f_C2& complex, iu::VolumeCpu_64f_C1& real);
IUCORE_DLLAPI void imag(iu::VolumeGpu_64f_C2& complex, iu::VolumeGpu_64f_C1& real);
IUCORE_DLLAPI void imag(iu::ImageCpu_64f_C2& complex, iu::ImageCpu_64f_C1& real);
IUCORE_DLLAPI void imag(iu::ImageGpu_64f_C2& complex, iu::ImageGpu_64f_C1& real);
...
IUCORE_DLLAPI void phase(iu::LinearDeviceMemory<float2, 3>& complex, iu::LinearDeviceMemory<float, 3>& real);
IUCORE_DLLAPI void phase(iu::LinearHostMemory<float2, 4>& complex, iu::LinearHostMemory<float, 4>& real);
IUCORE_DLLAPI void phase(iu::LinearDeviceMemory<float2, 4>& complex, iu::LinearDeviceMemory<float, 4>& real);
IUCORE_DLLAPI void phase(iu::LinearHostMemory<float2, 5>& complex, iu::LinearHostMemory<float, 5>& real);
IUCORE_DLLAPI void phase(iu::LinearDeviceMemory<float2, 5>& complex, iu::LinearDeviceMemory<float, 5>& real);

IUCORE_DLLAPI void phase(iu::VolumeCpu_64f_C2& complex, iu::VolumeCpu_64f_C1& real);
IUCORE_DLLAPI void phase(iu::VolumeGpu_64f_C2& complex, iu::VolumeGpu_64f_C1& real);
IUCORE_DLLAPI void phase(iu::ImageCpu_64f_C2& complex, iu::ImageCpu_64f_C1& real);
IUCORE_DLLAPI void phase(iu::ImageGpu_64f_C2& complex, iu::ImageGpu_64f_C1& real);
...
IUCORE_DLLAPI void scale(iu::LinearDeviceMemory<float2, 3>& complex_src, const float& scale, iu::LinearDeviceMemory<float2, 3>& complex_dst);
IUCORE_DLLAPI void scale(iu::LinearHostMemory<float2, 4>& complex_src, const float& scale, iu::LinearHostMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void scale(iu::LinearDeviceMemory<float2, 4>& complex_src, const float& scale, iu::LinearDeviceMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void scale(iu::LinearHostMemory<float2, 5>& complex_src, const float& scale, iu::LinearHostMemory<float2, 5>& complex_dst);
IUCORE_DLLAPI void scale(iu::LinearDeviceMemory<float2, 5>& complex_src, const float& scale, iu::LinearDeviceMemory<float2, 5>& complex_dst);

IUCORE_DLLAPI void scale(iu::VolumeCpu_64f_C2& complex_src, const double& scale, iu::VolumeCpu_64f_C2& complex_dst);
IUCORE_DLLAPI void scale(iu::VolumeGpu_64f_C2& complex_src, const double& scale, iu::VolumeGpu_64f_C2& complex_dst);
IUCORE_DLLAPI void scale(iu::ImageCpu_64f_C2& complex_src, const double& scale, iu::ImageCpu_64f_C2& complex_dst);
IUCORE_DLLAPI void scale(iu::ImageGpu_64f_C2& complex_src, const double& scale, iu::ImageGpu_64f_C2& complex_dst);
...
IUCORE_DLLAPI void multiply(iu::LinearDeviceMemory<float2, 3>& complex_src, iu::LinearDeviceMemory<float, 3>& real, iu::LinearDeviceMemory<float2, 3>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearHostMemory<float2, 4>& complex_src, iu::LinearHostMemory<float, 4>& real, iu::LinearHostMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearDeviceMemory<float2, 4>& complex_src, iu::LinearDeviceMemory<float, 4>& real, iu::LinearDeviceMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearHostMemory<float2, 5>& complex_src, iu::LinearHostMemory<float, 5>& real, iu::LinearHostMemory<float2, 5>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearDeviceMemory<float2, 5>& complex_src, iu::LinearDeviceMemory<float, 5>& real, iu::LinearDeviceMemory<float2, 5>& complex_dst);

IUCORE_DLLAPI void multiply(iu::VolumeCpu_64f_C2& complex_src, iu::VolumeCpu_64f_C1& real, iu::VolumeCpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiply(iu::VolumeGpu_64f_C2& complex_src, iu::VolumeGpu_64f_C1& real, iu::VolumeGpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiply(iu::ImageCpu_64f_C2& complex_src, iu::ImageCpu_64f_C1& real, iu::ImageCpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiply(iu::ImageGpu_64f_C2& complex_src, iu::ImageGpu_64f_C1& real, iu::ImageGpu_64f_C2& complex_dst);
...
IUCORE_DLLAPI void multiply(iu::LinearDeviceMemory<float2, 3>& complex_src, iu::LinearDeviceMemory<float2, 3>& complex_src2, iu::LinearDeviceMemory<float2, 3>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearHostMemory<float2, 4>& complex_src, iu::LinearHostMemory<float2, 4>& complex_src2, iu::LinearHostMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearDeviceMemory<float2, 4>& complex_src, iu::LinearDeviceMemory<float2, 4>& complex_src2, iu::LinearDeviceMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearHostMemory<float2, 5>& complex_src, iu::LinearHostMemory<float2, 5>& complex_src2, iu::LinearHostMemory<float2, 5>& complex_dst);
IUCORE_DLLAPI void multiply(iu::LinearDeviceMemory<float2, 5>& complex_src, iu::LinearDeviceMemory<float2, 5>& complex_src2, iu::LinearDeviceMemory<float2, 5>& complex_dst);

IUCORE_DLLAPI void multiply(iu::VolumeCpu_64f_C2& complex_src1, iu::VolumeCpu_64f_C2& complex_src2, iu::VolumeCpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiply(iu::VolumeGpu_64f_C2& complex_src1, iu::VolumeGpu_64f_C2& complex_src2, iu::VolumeGpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiply(iu::ImageCpu_64f_C2& complex_src1, iu::ImageCpu_64f_C2& complex_src2, iu::ImageCpu_64f_C2& complex_dst);
...
IUCORE_DLLAPI void multiplyConjugate(iu::LinearHostMemory<float2, 2>& complex_src, iu::LinearHostMemory<float2, 2>& complex_src2, iu::LinearHostMemory<float2, 2>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearDeviceMemory<float2, 2>& complex_src, iu::LinearDeviceMemory<float2, 2>& complex_src2, iu::LinearDeviceMemory<float2, 2>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearHostMemory<float2, 3>& complex_src, iu::LinearHostMemory<float2, 3>& complex_src2, iu::LinearHostMemory<float2, 3>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearDeviceMemory<float2, 3>& complex_src, iu::LinearDeviceMemory<float2, 3>& complex_src2, iu::LinearDeviceMemory<float2, 3>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearHostMemory<float2, 4>& complex_src, iu::LinearHostMemory<float2, 4>& complex_src2, iu::LinearHostMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearDeviceMemory<float2, 4>& complex_src, iu::LinearDeviceMemory<float2, 4>& complex_src2, iu::LinearDeviceMemory<float2, 4>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearHostMemory<float2, 5>& complex_src, iu::LinearHostMemory<float2, 5>& complex_src2, iu::LinearHostMemory<float2, 5>& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::LinearDeviceMemory<float2, 5>& complex_src, iu::LinearDeviceMemory<float2, 5>& complex_src2, iu::LinearDeviceMemory<float2, 5>& complex_dst);

IUCORE_DLLAPI void multiplyConjugate(iu::VolumeCpu_64f_C2& complex_src1, iu::VolumeCpu_64f_C2& complex_src2, iu::VolumeCpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::VolumeGpu_64f_C2& complex_src1, iu::VolumeGpu_64f_C2& complex_src2, iu::VolumeGpu_64f_C2& complex_dst);
IUCORE_DLLAPI void multiplyConjugate(iu::ImageCpu_64f_C2& complex_src1, iu::ImageCpu_64f_C2& complex_src2, iu::ImageCpu_64f_C2& complex_dst);
