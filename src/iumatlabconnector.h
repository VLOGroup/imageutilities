 ...
 * \param dst Destination image on the host.
 */
IU_DLLAPI IuStatus convertMatlabToCpu(float* matlab_src_buffer, unsigned int width, unsigned int height,
                                      iu::ImageCpu_32f_C1 *dst);
 ...
 * \param dst Destination image on the host.
 */
IU_DLLAPI IuStatus convertMatlabToCpu(int* matlab_src_buffer, unsigned int width, unsigned int height,
 ...
 * \param dst Destination image on the device.
 */
IU_DLLAPI IuStatus convertMatlabToGpu(int* matlab_src_buffer, unsigned int width, unsigned int height,
 ...
 * \param dst Destination image on the device.
 */                                 
IU_DLLAPI IuStatus convertMatlabC2ToCpuC2(double *matlab_src_buffer, unsigned int width, unsigned int height, 
 ...
 * \param dst Destination image on the device.
 */                              
IU_DLLAPI IuStatus convertMatlabC4ToCpuC4(double *matlab_src_buffer, unsigned int width, unsigned int height, 
                                iu::ImageCpu_32f_C4 *dst);                                          
 ...
 * \param dst Destination image on the device.
 */                                          
IU_DLLAPI IuStatus convertMatlabC2ToGpuC2(double *matlab_src_buffer, unsigned int width, unsigned int height,
 ...
 * \param dst Destination image on the device.
 */                                          
IU_DLLAPI IuStatus convertMatlabC4ToGpuC4(double *matlab_src_buffer, unsigned int width, unsigned int height,
                                          iu::ImageGpu_32f_C4 *dst);
 ...
 * \param dst matlab_dst_buffer image in matlab layout.
 */
IU_DLLAPI IuStatus convertCpuC4ToMatlabC4(iu::ImageCpu_32f_C4 *src, double* matlab_dst_buffer);

/** Converts an 2-channel ImageCpu to 2-channel matlab memory layout memory layout.
 * \param src Source color image.
 * \param dst matlab_dst_buffer image in matlab layout.
 */
IU_DLLAPI IuStatus convertCpuC2ToMatlabC2(iu::ImageCpu_32f_C2 *src, double* matlab_dst_buffer);
 ...
 * \param dst matlab_dst_buffer image in matlab layout.
 */
IU_DLLAPI IuStatus convertGpuC2ToMatlabC2(iu::ImageGpu_32f_C2 *src, double* matlab_dst_buffer);
 ...
 * \param dst matlab_dst_buffer image in matlab layout.
 */
IU_DLLAPI IuStatus convertGpuC4ToMatlabC4(iu::ImageGpu_32f_C4 *src, double* matlab_dst_buffer);
 ...
 * \param dst Destination image on the host.
 */
IU_DLLAPI IuStatus convertCpuToMatlab(ImageCpu_8u_C1 *src,
 ...
 * \param dst Destination image on the device.
 */
IU_DLLAPI IuStatus convertGpuToMatlab(ImageGpu_8u_C1 *src,
                                      unsigned char* matlab_dst_buffer, unsigned int width, unsigned int height);
