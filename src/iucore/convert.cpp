 ...
 * ***************************************************************************/
extern void cuConvert(const iu::ImageGpu_32f_C3* src, const IuRect& src_roi,
                          iu::ImageGpu_32f_C4* dst, const IuRect& dst_roi);
extern void cuConvert(const iu::ImageGpu_32f_C4* src, const IuRect& src_roi,
                          iu::ImageGpu_32f_C3* dst, const IuRect& dst_roi);
extern void cuConvert_8u_32f(const iu::ImageGpu_8u_C1* src, const IuRect& src_roi,
                                 iu::ImageGpu_32f_C1* dst, const IuRect& dst_roi,
                                 float mul_constant,  float add_constant);
extern void cuConvert_8u_32f_C3C4(const iu::ImageGpu_8u_C3* src, const IuRect& src_roi,
                                 iu::ImageGpu_32f_C4* dst, const IuRect& dst_roi,
                                 float mul_constant,  float add_constant);
extern void cuConvert_32f_8u(const iu::ImageGpu_32f_C1* src, const IuRect& src_roi,
                                 iu::ImageGpu_8u_C1* dst, const IuRect& dst_roi,
                                 float mul_constant, unsigned char add_constant);
extern void cuConvert_32f_8u(const iu::ImageGpu_32f_C4* src, const IuRect& src_roi,
                      ...
                      float mul_constant, unsigned char add_constant)
{
  ...
  cuConvert_32f_8u(src, src_roi, dst, dst_roi, mul_constant, add_constant);
                      ...
                      float mul_constant, float add_constant)
{
  ...
  cuConvert_8u_32f(src, src_roi, dst, dst_roi, mul_constant, add_constant);
                      ...
                      float mul_constant, float add_constant)
{
  ...
  cuConvert_8u_32f_C3C4(src, src_roi, dst, dst_roi, mul_constant, add_constant);
...
void convert(const iu::ImageGpu_32f_C3* src, const IuRect& src_roi, iu::ImageGpu_32f_C4* dst, const IuRect& dst_roi)
{
  ...
  cuConvert(src, src_roi, dst, dst_roi);
